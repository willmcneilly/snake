...
(function() {
  ...
  Snake = (function() {
    ...
    Snake.prototype.generateCherry = function() {
      this.cherry.x = this.getRandomInt(0, this.options.canvasWidth / this.cherry.width) * this.cherry.width;
      this.cherry.y = this.getRandomInt(0, this.options.canvasHeight / this.cherry.height) * this.cherry.height;
